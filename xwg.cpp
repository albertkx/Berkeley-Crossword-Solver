...
static const int EXP_MULTIPLIER = 2;
...
void solver_frame::create_layout()
{
  ...
  text = new wxTextCtrl(this, wxID_ANY, " ",
                        wxDefaultPosition,
                        wxSize(300 * EXP_MULTIPLIER,grid_size()),
                        wxTE_MULTILINE | wxTE_READONLY | wxTE_RICH);
  wxTextAttr def = text->GetDefaultStyle();
  def.SetFontSize(EXP_MULTIPLIER * def.GetFontSize());
  text->SetDefaultStyle(def);
