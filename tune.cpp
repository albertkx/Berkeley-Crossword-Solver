...
{                                       // * = requires reinitialization
  details[CBOUND]             = 3.45e-5; // *
  details[PBOUND]             = 2.5e-6; // *
  details[FBOUND]             = 5e-7;   // *
  details[PWEIGHT]            = 0.55;   // *
  details[FWEIGHT]            = 0.33;   // *
  details[INEXACT]            = 1.95;   // ! inexact weight, original
  details[ABBRV_LIMIT]        = 1e-6;   // !
  details[IS_ABBRV]           = 0.63;   // * 
  details[SCALE_BY_CROSSERS]  = 0.24;
  details[THREE_LETTERS]      = 1.2;
  details[NON_DICT_CHARGE]    = 22.7;
  details[NON_DICT_TRANSITION] = 8.76;
  details[NON_MULTI_CHARGE]   = 26.36;
  details[PWEIGHT_M]          = 0.03;
  details[DICT_CHARGE]        = 4.76;
  details[WORD_CHARGE]        = 41.9;
  details[EXTRA_WORD_CHARGE]  = 1.98;
  details[MATCHBASE]          = 0.48;
  details[UNMATCH]            = 0.19;
  details[FITB_BONUS]         = 1.9;    // *
  details[FITB_LIMIT]         = 10.7;   // ! (total reset)
